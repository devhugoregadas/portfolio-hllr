      ...
      <Section delay={0.3}>
        <SimpleGrid columns={[1, 2, 2]} gap={6}>
          <GridItem
            ...
            githubSource="https://github.com/devhugoregadas/airbnb-clone-nextjs/tree/master"
          />
          <GridItem
            title="Google Docs Next.js"
            thumbnail={thumbGoogleDocsNextjs}
            iveView="https://google-docs-nextjs-tailwind.vercel.app"
            githubSource="https://github.com/devhugoregadas/google-docs-nextjs-tailwind/tree/master"
          />
        </SimpleGrid>
      </Section>
