    ...
    <Layout title="Bounce App">
      <Container>
        ...
        <List ml={4} my={4}>
          ...
          <ListItem>
            <Meta>HOW</Meta>
            <span href="https://speakerdeck.com/craftzdog/the-fun-deep-learning">
            Bounce was designed to be easy to use, but if you're not quite sure how everything works we're here for you. Follow these simple steps:<ExternalLinkIcon mx="2px" />
            </span>
          </ListItem>
          <ListItem>
            <Meta>Blogpost</Meta>
